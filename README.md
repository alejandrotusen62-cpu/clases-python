...
Practica de GitHub con un proyecto Tkinter para gestionar tareas.
...
class AppWindow(tk.Tk):
    ...
    def __init__(self, task_service: TaskService) -> None:
        ...
        self.users: list[dict[str, str]] = [
            ...
            {"fname": "Carlos", "lname": "Rodriguez", "age": "37"},
            {"fname": "Maria", "lname": "Rosario", "age": "28"},
        ]
        # Widgets
        self.create_widgets()
    ...
    def create_widgets(self) -> None:
        ...
        button = tk.Button(self, text="Insertar usuarios", command=self.get_user)
        button.pack()
